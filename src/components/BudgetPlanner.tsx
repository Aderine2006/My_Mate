...
const BudgetPlanner: React.FC<BudgetPlannerProps> = ({ user, theme }) => {
    ...
    // ============ Shared Styles ============
    const cardClass = 'bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 p-6';
    const inputClass = 'w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500';
    const btnPrimary = 'px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors font-medium';
        ...
        <div>
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                ...
                <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors shadow-sm text-sm font-medium"
                >
                    <Download size={18} />
            ...
            <div className="flex items-center gap-4 mb-6">
                <button onClick={() => navigateMonth(-1)} className="px-3 py-1 bg-gray-200 dark:bg-gray-700 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200 transition-colors">&larr;</button>
                ...
                <button onClick={() => navigateMonth(1)} className="px-3 py-1 bg-gray-200 dark:bg-gray-700 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200 transition-colors">&rarr;</button>
            </div>

            {/* Sub-Tab Navigation */}
            <div className="flex flex-wrap gap-2 mb-6 bg-gray-100 dark:bg-gray-800 p-1 rounded-xl">
                {subTabs.map(tab => (
                    <button
                        key={tab.id}
            ...
            {activeSubTab === 'summary' && (
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/30 dark:to-emerald-900/30 rounded-xl shadow p-5 border border-green-200 dark:border-green-800">
                        ...
                        <div className="bg-gradient-to-br from-red-50 to-rose-50 dark:from-red-900/30 dark:to-rose-900/30 rounded-xl shadow p-5 border border-red-200 dark:border-red-800">
                            <div className="flex items-center justify-between mb-2">
                        ...
                        <div className={`bg-gradient-to-br ${balance >= 0 ? 'from-blue-50 to-indigo-50 dark:from-blue-900/30 dark:to-indigo-900/30 border-blue-200 dark:border-blue-800' : 'from-orange-50 to-red-50 dark:from-orange-900/30 dark:to-red-900/30 border-orange-200 dark:border-orange-800'} rounded-xl shadow p-5 border`}>
                            <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="bg-gradient-to-br from-purple-50 to-violet-50 dark:from-purple-900/30 dark:to-violet-900/30 rounded-xl shadow p-5 border border-purple-200 dark:border-purple-800">
                            <div className="flex items-center justify-between mb-2">
                    ...
                    <div className={cardClass}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            {EXPENSE_CATEGORIES.map(cat => {
                                ...
                                return (
                                    <div key={cat} className={`p-4 rounded-lg border ${isOver ? 'border-red-300 dark:border-red-700 bg-red-50 dark:bg-red-900/20' : 'border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50'}`}>
                                        <div className="flex items-center justify-between mb-2">
                                        ...
                                        {limit > 0 && (
                                            <>
                                                <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2 mt-2">
                                                    <div className={`h-2 rounded-full transition-all ${isOver ? 'bg-red-500' : pct > 80 ? 'bg-yellow-500' : 'bg-green-500'}`} style={{ width: `${Math.min(pct, 100)}%` }} />
                                                </div>
                    ...
                    {showIncomeForm && (
                        <div className={cardClass}>
                            ...
                            <div className="flex gap-3 mt-4">
                                ...
                                <button onClick={resetIncomeForm} className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 transition-colors">Cancel</button>
                            </div>
                        </div>
                    )}
                    ...
                    {showExpenseForm && (
                        <div className={cardClass}>
                            ...
                            <div className="flex gap-3 mt-4">
                                ...
                                <button onClick={resetExpenseForm} className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 transition-colors">Cancel</button>
                            </div>
                        </div>
                    )}
                        ...
                        <div className="space-y-3">
                            {monthExpenses.sort((a, b) => b.date.localeCompare(a.date)).map(exp => (
                                <div key={exp.id} className={`${cardClass} flex items-center justify-between`}>
                                    <div className="flex items-center gap-3">
                                        <div className="w-3 h-3 rounded-full flex-shrink-0" style={{ backgroundColor: CATEGORY_COLORS[exp.category] }} />
                                        <div>
                    ...
                    {showBudgetForm && (
                        <div className={cardClass}>
                            ...
                            <div className="flex gap-3 mt-4">
                                ...
                                <button onClick={() => setShowBudgetForm(false)} className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 transition-colors">Cancel</button>
                            </div>
                        </div>
                    )}
                                    ...
                                    {limit > 0 ? (
                                        <>
                                            <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-3 mb-2">
                                                <div className={`h-3 rounded-full transition-all duration-500 ${isOver ? 'bg-red-500' : pct > 80 ? 'bg-yellow-500' : 'bg-green-500'}`} style={{ width: `${Math.min(pct, 100)}%` }} />
                                            </div>
                                            ...
                                            {isOver && (
                                                <div className="flex items-center gap-2 mt-3 p-2 bg-red-50 dark:bg-red-900/30 rounded-lg">
                    ...
                    {showGoalForm && (
                        <div className={cardClass}>
                            ...
                            <div className="flex gap-3 mt-4">
                                ...
                                <button onClick={resetGoalForm} className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 transition-colors">Cancel</button>
                            </div>
                        </div>
                    )}
                                ...
                                return (
                                    <div key={goal.id} className={cardClass}>
                                        ...
                                        <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-4 mb-2">
                                            <div className={`h-4 rounded-full transition-all duration-700 ${pct >= 100 ? 'bg-green-500' : pct >= 50 ? 'bg-indigo-500' : 'bg-yellow-500'}`} style={{ width: `${pct}%` }}>
